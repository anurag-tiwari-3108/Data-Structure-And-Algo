 ...
 * integers. The subarray should contain all distinct values. The problem
 * differs from the problem of finding the longest subsequence formed by
 * consecutive integers. Unlike subsequences, subarrays are required to occupy
 * consecutive positions within the original array.
 *
 * 
 * 
 */
public class LargestSubarrayWithDistinctValues {
